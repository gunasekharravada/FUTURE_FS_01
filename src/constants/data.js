export const NAV_ITEMS = ["Home", "About", "Skills", "Projects", "Resume", "Contact"];
export const TYPING_WORDS = ["Full Stack Developer", "React Developer"];

export const SKILLS_DATA = [
  { cat: "Frontend", icon: "🎨", items: [{ n: "HTML5", p: 92 }, { n: "CSS3", p: 88 }, { n: "JavaScript", p: 85 }, { n: "React.js", p: 82 }] },
  { cat: "Database", icon: "🗄️", items: [{ n: "MongoDB", p: 68 }, { n: "Firebase", p: 72 }] },
  { cat: "Tools", icon: "🔧", items: [{ n: "Git & GitHub", p: 85 }, { n: "VS Code", p: 90 }, { n: "Excel", p: 75 }] },
...
export const TIMELINE_DATA = [
  ...
  { year: "2025 – Present", title: "B.Tech – Computer Science Engineering", org: "Vignan's Institute of Information Technology (JNTU-GV) ", desc: "I am focused on building my technical skills and preparing for an career in the dynamic field of computer science." },
  { year: "2026 – Summer", title: "Future Intern Internship", org: "Full Stack Web Developement", desc: "During my internship, I gained valuable hands-on experience in full stack web developement." },
  { year: "2026 – Present", title: "AI Learning Journey", org: "Self-directed & Online Courses", desc: "Exploring machine learning, NLP, deep learning frameworks (TensorFlow/PyTorch), and building AI-powered applications." },
];